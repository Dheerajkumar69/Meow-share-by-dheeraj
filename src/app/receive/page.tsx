      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground">Enter the share code to download your file</p>
          </div>
          ...
          {!fileInfo && (
            <Card className="mb-6">
              <CardHeader>
                ...
                <CardDescription>
                  Enter the 8-character code you received to access the shared file
                </CardDescription>
              </CardHeader>
              <CardContent>
                <form onSubmit={handleCodeSubmit} className="space-y-4">
                  ...
                  <div className="text-center">
                    <Button
                      ...
                      size="sm"
                      onClick={() => {
                        const demoCode = 'DEMO-1234'
                        setCode(demoCode)
                        setTimeout(() => handleCodeSubmit({ preventDefault: () => {} } as React.FormEvent), 100)
                      }}
                    >
                      Try Demo Code: DEMO-1234
                    </Button>
                  </div>
                </form>
              </CardContent>
